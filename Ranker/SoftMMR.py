                ...
                for other in best:
                    ...
                    if self.beta != 0:  # since the value of beta is set to 0.5
                        try:
                            ...
                            current_sent_sim = (self.beta * sim) + ((1 - self.beta) * pos_dict[sentence])
                        except:
                            current_sent_sim = (self.beta * sim) + ((1 - self.beta) * pos_dict[sentence.lstrip().rstrip()])
                    else:
